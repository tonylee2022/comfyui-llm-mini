...
const translations = {
  ...
  "start_image": { zh: "开始图像", en: "Start Image" },
  "end_image": { zh: "结束图像", en: "End Image" },
  "assistant_response": { zh: "助手回复", en: "Assistant Response" },
  "history_json": { zh: "历史记录 JSON", en: "History JSON" },
  "persona_name": { zh: "人格面具", en: "Persona" },
  "source_language": { zh: "输入语言", en: "Source Language" },
  "target_language": { zh: "输出语言", en: "Target Language" },
  "tone": { zh: "语气", en: "Tone" },
  "tone_degree": { zh: "语气程度", en: "Tone Strength" },
  ...
  "duration_seconds": { zh: "时长", en: "Duration" },
  "person_generation": { zh: "人像生成", en: "Person Generation" },
  "enhance_prompt": { zh: "提示词增强", en: "Enhance Prompt" },
